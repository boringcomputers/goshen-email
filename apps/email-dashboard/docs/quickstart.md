---
title: Quickstart
description: Create an API key, create an inbox, send a message, and read the reply, in about five minutes.
---
...
```json
{
  "inboxId": "research@{{DEFAULT_DOMAIN}}",
  "address": "research@{{DEFAULT_DOMAIN}}",
