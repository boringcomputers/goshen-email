...
description: A typed client for Node.js 24 and other modern runtimes. One method per API operation, plus page iteration.
---
...
| `baseUrl` | API origin. Defaults to `{{API_BASE}}`. |
