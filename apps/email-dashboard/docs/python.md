---
title: Python SDK
description: A synchronous client for Python 3.10 and later, built on the standard library. One method per API operation.
---
...
email = BezalelEmail(
    ...
    base_url=os.environ.get('BEZALEL_BASE_URL', '{{API_BASE}}'),
