...
import { docsAssets } from './docs-assets.mjs'

// Fixed list of files the dashboard serves. Documentation pages are generated by
// scripts/build-docs.mjs, which also writes their routes into docs-assets.mjs.
export const assets = new Map([
  ...
  ['/site-header.js', ['site-header.js', 'text/javascript; charset=utf-8']],
