...
(() => {
  const titles = Object.freeze({ inboxes: 'Inboxes', mail: 'Inboxes', 'api-keys': 'API keys', integrations: 'Integrations', domains: 'Domains', setup: 'Get started', settings: 'Settings' })
  function parse(hash) {
    let parts
