...
Requires scope `messages:read`. MCP tool `get_message`. CLI `goshenemail messages get`.
...
```sh
curl "https://api.goshenemail.com/v1/inboxes/research%40agents.goshenemail.com/messages/%3C20260920.12345%40agents.goshenemail.com%3E" \
...
```sh
goshenemail messages get --inbox-id "research@agents.goshenemail.com" --message-id "<20260920.12345@agents.goshenemail.com>"
```
