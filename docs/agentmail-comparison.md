...
| --- | --- | --- |
| API | Account keys and resource endpoints | 15 versioned operations; account and mailbox keys; OpenAPI |
...
| Inboxes and mail | Inbox lifecycle, sends/replies, threads, attachments, labels | Account inbox creation/deletion; existing read/search/send/reply/label/attachment operations |
